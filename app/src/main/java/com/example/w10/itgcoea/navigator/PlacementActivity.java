...
public class PlacementActivity extends AppCompatActivity {
    ...
    public String PDF_FETCH_URL = "http://10.162.11.47/AndroidPdfUpload/getPdfs4.php";
    String year="",value;
    ...
    private void getPdfs() {
        ...
        progressDialog.setMessage("Fetching Placement Records... Please Wait");
        progressDialog.show();
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Toast.makeText(PlacementActivity.this,obj.getString("message"), Toast.LENGTH_SHORT).show();
                            ...
                            pdfAdapter=new PdfAdapter(PlacementActivity.this,R.layout.list_layout, pdfList);
