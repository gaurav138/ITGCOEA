...
public class UpdatetheSyllabus extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_updatethe_syllabus);
        ...
        buttonUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i1=new Intent(UpdatetheSyllabus.this,UpdatetheSyllabus2.class);

                startActivity(i1);
            }
        });
        Typeface d=Typeface.createFromAsset(getAssets(), "fonts/description.otf");
        buttonUpdate.setTypeface(d);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Toast.makeText(UpdatetheSyllabus.this,obj.getString("message"), Toast.LENGTH_SHORT).show();
                            ...
                            pdfAdapter=new PdfAdapter(UpdatetheSyllabus.this,R.layout.list_layout, pdfList);
