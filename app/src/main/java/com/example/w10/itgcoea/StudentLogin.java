        ...
        bLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (username.equals("g") && password.equals("1")) {
                    ...
                    Response.Listener<String> responseListener = new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                Intent intent = new Intent(StudentLogin.this, UserAreaActivity.class);
                                ...
                                intent.putExtra("username", username);*/
                                    ...
                                    String name=jsonResponse.getString("name");
                                    int roll_no=jsonResponse.getInt("roll_no");
                    ...
                    LoginRequest2 loginRequest2 = new LoginRequest2(username, password, responseListener);
